...
var switchesFormat = "-port=%d -url-base=%s -log-path=%s -http-threads=%d --user-agent=%d"
...
func (d *ChromeDriver) Start() error {
	...
	switches = append(switches, "--user-agent=Mozilla/5.0 (iPad; CPU OS 5_0 like Mac OS X) AppleWebKit/534.46 (KHTML, like Gecko) Version/5.1 Mobile/9A334 Safari/7534.48.3")
	if d.BaseUrl != "" {
